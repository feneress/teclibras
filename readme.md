...
Este projeto é uma aplicação completa com **backend** e **frontend** integrados. A parte backend utiliza **Node.js** com um banco de dados [MySQL], enquanto o frontend está estruturado em HTML, CSS ,JavaScript e JQuery, sendo servido por meio do **Live Server**.
...
<!- Quem usa o mysql colocar também essa parte embaixo ->
...
#### 5. Banco de Dados: No arquivo [connectionjs], substitua as credenciais do banco de dados com as suas (nome do banco, host e senha).
#### 6. Script do banco de dados: O script está no arquivo [db.sql]. Execute o conteúdo deste arquivo no seu banco de dados MySQL para criar as tabelas necessárias.
